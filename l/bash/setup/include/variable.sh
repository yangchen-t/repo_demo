...
readonly TOOLS_2="yq"
readonly PROJECT_YAML="./config.yaml"
readonly REFERENCE_SUPERVISORD_CONFIG="./cntshjtg.conf"
readonly SUPERVISOR_CONFIG="${WORKING_PATH}/supervisor.conf"
...
vProfileCheck() {
    if [ ! -f $1 ]; then
        T_Logger E "$1 is not exist";exit -1
    fi
}
